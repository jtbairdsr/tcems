 ...
 * @Last Modified time: 2015-05-02 20:43:20
 */

'use strict';

angular.module('core').factory('ShiftGroup', function(
	$q, Data, shiftGroups, currentSemester
) {
	...
	ShiftGroup.prototype.getActive = function() {
		return (
			this.Id === currentSemester.data.ShiftGroup.Id ||
			this.Id === currentSemester.data.NextSemesterId
		);
	};
	/**************************************************************************
	 *                              CLASS METHODS                             *
