 ...
 * @Last Modified time: 2015-05-04 11:50:21
 */
'use strict';
...
app.service('dataService', function($http, sharePointUrl, getClass, $timeout, cfpLoadingBar) {
	...
	that.postJson = function(params) {
		...
		_.extend(universalHeaders.headers, params.headers);
		return $http.post(sharePointUrl + params.uri, params.data, universalHeaders);
	};
