 ...
 * @Last Modified time: 2015-05-04 20:48:06
 */
...
angular.module('core').factory('Person', function(Data, currentUser) {
	...
	Person.prototype.propertyList = _.union(Data.prototype.propertyList, [
		'EmailAddress', 'FirstName', 'LastName', 'PhoneNumber', 'Picture', 'PreferredName'
	]);
	...
	Person.prototype.initAttributes = function() {
		...
		: 'src/modules/core/img/missing.png';
