(function() {
	...
	schedule.factory('refreshScheduleService', ['$scope, $modal, dataService',
		function($scope, $modal, dataService) {
			return function refreshScheduleService() {
	...
	schedule.controller('ScheduleCtrl', ['$location', '$scope', '$modal', 'dataService', 'refreshScheduleService',
		function($location, $scope, $modal, dataService, refreshScheduleService) {
			var ctrl = this;
